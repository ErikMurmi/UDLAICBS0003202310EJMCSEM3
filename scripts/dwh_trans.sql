...
DROP TABLE tra_times;
DROP TABLE tra_sales;
DROP TABLE tra_promotions;
DROP TABLE tra_products;
DROP TABLE tra_countries;
DROP TABLE tra_customers;
DROP TABLE tra_channel;

TRUNCATE TABLE tra_times;
TRUNCATE TABLE tra_sales;
TRUNCATE TABLE tra_promotions;
TRUNCATE TABLE tra_products;
TRUNCATE TABLE tra_countries;
TRUNCATE TABLE tra_customers;
TRUNCATE TABLE tra_channel;